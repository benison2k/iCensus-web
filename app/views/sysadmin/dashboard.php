<?php
// app/views/sysadmin/dashboard.php
...
<main class="dashboard">
    <div class="card-grid">
        ...
        <a href="/sysadmin/logs" class="card clickable-card">
        ...
        <a href="/settings" class="card clickable-card">
